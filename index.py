...
from apps import app1, app2, bar_chart, linecharts, scatterplotmat, scatterplotmat2, djia_vis, candlestick, linearregression
styling = {
    'background': '#111111',
    'text': '#7FDBFF',
    'padding': '14px',
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Link('Linear Regression | ', href='/apps/linearregression')
